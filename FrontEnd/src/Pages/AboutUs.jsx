    ...
    <div className="bg-gray-100 py-12 px-4 lg:px-8">
      <div className="max-w-7xl mx-auto text-center">
        ...
        <p className="text-gray-600 text-lg leading-relaxed mb-8">
          At <span className="text-green-500 font-semibold">Recipe Finder</span>, we believe cooking should be simple, fun, 
        ...
        <div className="flex justify-center">
          <img
            src="https://via.placeholder.com/600x400" // Replace with your image link
